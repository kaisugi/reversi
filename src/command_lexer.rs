...
fn check_tokenize() {
    ...
    assert_eq!(
        tokens,
        vec![Token::OPEN, Token::STR("Anon.".to_string()), Token::EOF]
    );
    ...
    assert_eq!(
        tokens,
        vec![Token::MOVE, Token::STR("D3".to_string()), Token::EOF]
    );
    ...
    assert_eq!(
        ...
        vec![
            ...
            Token::INT(29),
            Token::INT(35),
            Token::STR("DOUBLE_PASS".to_string()),
            Token::EOF
        ]
    );
    ...
    assert_eq!(
        ...
        vec![
            Token::BYE,
            Token::STR("playerA".to_string()),
            Token::INT(-4),
            Token::INT(0),
            Token::INT(4),
            Token::STR("playerB".to_string()),
            Token::INT(4),
            Token::INT(4),
            Token::INT(0),
            Token::EOF
